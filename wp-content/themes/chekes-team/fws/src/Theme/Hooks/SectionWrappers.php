...
class SectionWrappers extends SingletonHook
{
	...
	{
		// Wrapper actions
		add_action( 'chekes-team_before_main_content', [ $this, 'pageWrapperBefore' ] );
		add_action( 'chekes-team_after_main_content', [ $this, 'pageWrapperAfter' ] );
		add_action( 'chekes-team_before_archive_listing', [ $this, 'archiveWrapperBefore' ] );
		add_action( 'chekes-team_after_archive_listing', [ $this, 'archiveWrapperAfter' ] );
	}
}
