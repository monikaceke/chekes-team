...
class BasicSetup extends SingletonHook
{
	...
	public function addThemeSupport(): void
	{
		 ...
		 * If you're building a theme based on chekes-team, use a find and replace
		 * to change 'chekes-team' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'chekes-team', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'chekes-team_custom_background_args', array(
	...
	public function contentWidth(): void
	{
		...
		$GLOBALS['content_width'] = apply_filters( 'chekes-team_content_width', 640 );
	}
	...
	public function widgetsInit(): void
	{
		register_sidebar( array(
			'name' => esc_html__( 'Sidebar', 'chekes-team' ),
			'id' => 'sidebar-1',
			'description' => esc_html__( 'Add widgets here.', 'chekes-team' ),
