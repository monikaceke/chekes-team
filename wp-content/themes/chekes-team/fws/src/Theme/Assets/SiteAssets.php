...
class SiteAssets extends SingletonHook
{
	...
	public function setupAdminStylesAndScripts(): void
	{
		...
		wp_enqueue_style( 'chekes-team-admin-style', get_template_directory_uri() . '/dist/admin.css', [], $version );
		wp_enqueue_script( 'chekes-team-admin-script', get_template_directory_uri() . '/dist/admin.min.js', ['jquery'], $version, false );

		wp_localize_script('chekes-team-admin-script', $this->localizedObjectName, $this->localizedObjectValues);
	}
	...
	private function enqueueThemeStylesAndScripts(): void
	{
		...
		// Set Theme Site CSS
		wp_enqueue_style( 'chekes-team-style', get_stylesheet_uri(), [], $version );

		// Set Theme Site JS
		wp_enqueue_script( 'chekes-team-site-script', get_template_directory_uri() . '/dist/site.min.js', ['jquery'], $version, false );

		// Set Theme VueJS
		wp_enqueue_script( 'chekes-team-vuevendors-js', get_template_directory_uri() . '/dist/vue-build/js/chunk-vendors.js', [], $version, false );
		wp_enqueue_script( 'chekes-team-vueapp-js', get_template_directory_uri() . '/dist/vue-build/js/app.js', [], $version, false );

		// Localize JS Object
		wp_localize_script('chekes-team-site-script', $this->localizedObjectName, $this->localizedObjectValues);
	}
