		...
		<div class="row">
			<div class="col-lg-6">
				<div class="banner__content">
					<h1 class="page-title gsap-page-title">Welcome!</h1>
					<div class="entry-content">
						<p>“A dog is the only thing on earth that loves you more than you love yourself.” <br> Josh Billings</p>
					</div>
			...
			<div class="col-lg-6">
				<div class="banner__image gasp-bottom">
					<img src="<?php echo fws()->images()->assetsSrc( 'banner-home.png', true ); ?>" alt="">
				</div>
			</div>
		</div>
	</div>
