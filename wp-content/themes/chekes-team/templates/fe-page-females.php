...
// get content blocks
get_template_part( 'template-views/blocks/banner/_fe-banner--females' );
get_template_part( 'template-views/blocks/cards/_fe-cards--females' );
